...
def au_Exp():
    ...
    test_data,test_lable,train_data,train_lable = cT.getOdateblood()


    model = models.Sequential()
    model.add(layers.Conv1D(64,7,activation=jihuo,input_shape=(700,1)))     #输入形状依据样品进行变换，此处柴油为401
