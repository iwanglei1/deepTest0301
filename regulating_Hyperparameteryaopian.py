...
def au_Exp():
    ...
    spec,hardness = gD.getOdatePills()   ## len(spec) is 650
    test_data,test_lable,train_data,train_lable = sF.getTestDataPills(spec,hardness)


    model = models.Sequential()
    model.add(layers.Conv1D(64,7,activation=jihuo,input_shape=(650,1)))     #输入形状依据样品进行变换，此处药片光谱为650
